...
const Footer = () => {
  return (
    <footer className='flex w-full justify-start items-center bg-fsblack text-white space-x-4 border-t border-[#222222] px-6'><div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
